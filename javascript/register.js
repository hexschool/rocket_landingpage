...
const timeline = {
  ...
  content: [
    ...
    },
    {
      id: 2,
      question: "預期招募的組別？",
      answer: "本次招募組別為 C# 後端組、JS 軟體工程師組。",
    },
    {
      id: 3,
      question: "最新梯次的報名時間？",
      answer: "即日起 ~ 2026/06/25 (四) 23:59 截止（截止隔日寄面試通知信，需在期限內回覆）。",
    },
    {
      id: 4,
      question: "什麼時候會進行面試？",
      answer:
        "2026/06/30 (二) 10:00~12:00。面試地點為高雄火箭隊培訓營基地（捷運信義國小附近）。",
    },
    {
      id: 5,
      question: "什麼時候會有錄取通知？",
      answer: "2026/07/03 (五)，將以 Email 進行通知。",
    },
  ],
};
    ...
    content: [
      {
        ...
        answer: `不會有任何費用，僅需要場地費 ( $${price} / Month )，其餘完全免費。`,
      },
      {
        id: 2,
        question: "你們不是直銷吧？",
    ...
    content: [
      {
        ...
        question: "會幫忙協助媒合嗎？",
        answer:
          "會視每位同學的學習狀態進行評估。火箭隊教練都是在南部業界超過十年以上的工作經歷，我們主要也是希望透過此服務來協助在地媒合。",
      },
      {
        id: 2,
        question: "那一定會上嗎？",
